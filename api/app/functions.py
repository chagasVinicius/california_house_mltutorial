...
class Functions:
    ...
    def model_predict(self, model, ave_rooms, house_age, latitude, med_inc, ave_occup, longitude,
        ...
        Args:
            ...
            model: the trained California House Price model
            ave_rooms, house_age, latitude, med_inc, ave_occup, longitude, population, ave_bedrms
