...
def house_price():
    ...
    query_arg = {
        "ave_rooms": fields.Float(required=True, validate=validate_numbers),
        "house_age": fields.Float(required=True, validate=validate_numbers),
        "latitude": fields.Float(required=True, validate=validate_numbers),
        "med_inc": fields.Integer(required=False, missing=0, validate=validate_numbers),
        "ave_occup": fields.Float(required=True, validate=validate_numbers),
        "longitude": fields.Float(required=True, validate=validate_numbers),
        "population": fields.Float(required=True, validate=validate_numbers),
        "ave_bedrms": fields.Float(required=True, validate=validate_numbers),
    }
    ...
    # global model
    price = functions.model_predict(model, ave_rooms, house_age, latitude, med_inc, ave_occup, longitude,
